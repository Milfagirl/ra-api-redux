...
const services = [
    ...
    { id: nextId++, name: 'Ремонт 1', price: 2500, content: 'Оригинальный от Apple'},
    { id: nextId++, name: 'Ремонт 2', price: 2600, content: 'Оригинальный от Apple'},
    { id: nextId++, name: 'Ремонт 3', price: 2700, content: 'Оригинальный от Apple'},
    { id: nextId++, name: 'Ремонт 4', price: 2800, content: 'Оригинальный от Apple'},
    { id: nextId++, name: 'Ремонт 5', price: 2900, content: 'Оригинальный от Apple'},
    { id: nextId++, name: 'Ремонт 6', price: 300, content: 'Оригинальный от Apple'},
    { id: nextId++, name: 'Ремонт 7', price: 400, content: 'Оригинальный от Apple'},
    { id: nextId++, name: 'Ремонт 8', price: 500, content: 'Оригинальный от Apple'},
];
